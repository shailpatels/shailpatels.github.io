...
\textbf{Languages:} \  C, \ \CPP, \ C\#, \ PHP, \ Python, \ Java, \ JavaScript, \ TypeScript, \ HTML/CSS, \ R, \ Zig  \vspace{0.5em}\\
\textbf{Software \& Tools:} \ git,\ Laravel,\ RStudio, \ React, \ \LaTeX \vspace{0.1in}\\
...
\begin{itemize}
	...
	\begin{itemize*}
		\item Modern \CPP development on a distributed system	
		\item Software engineering in an agile workflow 
        \item Developed GPU accelerated signal processing chains through Nvidia CUDA toolkit 
        \item Integrated existing programs and modules and modified to fit new specifications
	...
	\begin{itemize*}
		...
		\item Google Summer of Code 2019-21 summer mentor
	\end{itemize*}
	\item
	\headerrow
		{\textbf{Cisco Systems}}
	...
	\begin{itemize*}
		...
		\item Racked, installed, and setup Cisco devices to build network recreates
